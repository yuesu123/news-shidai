...
- (void)viewDidLoad {
    ...
    [QTCommonTools clipAllView:_phoneNum Radius:kclipCorner borderWidth:1 borderColor:BlueColorCommon];
    [QTCommonTools clipAllView:_textView Radius:kclipCorner borderWidth:1 borderColor:BlueColorCommon];
...
//    [self sentRequest:self.phoneNum.text question:self.textView.text];
}
