...
//#define newRedCommon [UIColor colorWithRed:252.0/255 green:103.0/255 blue:109.0/255 alpha:1]
...
- (float)getDoubleValueForKey:(NSString*)key defaultValue:(float)defaultValue {
    id tmpValue = [self objectForKey:key];
