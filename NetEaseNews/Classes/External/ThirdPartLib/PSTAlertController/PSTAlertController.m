...
- (void)addCancelActionWithHandler:(void (^)(PSTAlertAction *action))handler {
    [self addAction:[PSTAlertAction actionWithTitle:@"取消" style:PSTAlertActionStyleCancel handler:handler]];
}
- (void)addCancelActionWithHandlerMSg:(NSString*)msg Handle:(void (^)(PSTAlertAction *action))handler{
       [self addAction:[PSTAlertAction actionWithTitle:msg style:PSTAlertActionStyleCancel handler:handler]];
}
//- (void)addCancelActionWithHandler1:(void (^)(PSTAlertAction *action))handler {
//
//}
@end
